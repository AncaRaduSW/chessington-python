...
class TestRooks:
    ...
    @staticmethod
    def test_rook_cannot_move_up_right_corner_direction():
    ...
    @staticmethod
    def test_rook_cannot_move_up_left_corner_direction():
        # Arrange
        board = Board.empty()
    ...
    @staticmethod
    def test_rook_cannot_move_down_right_corner_direction():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.WHITE)
    ...
    @staticmethod
    def test_rook_cannot_move_down_left_corner_direction():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
    ...
    @staticmethod
    def test_white_rook_cannot_move_up_if_white_piece_is_in_way():
    ...
    @staticmethod
    def test_white_rook_cannot_move_left_if_white_piece_is_in_way():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.WHITE)
        square = Square.at(3, 2)
    ...
    @staticmethod
    def test_white_rook_cannot_move_right_if_white_piece_is_in_way():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.WHITE)
        square = Square.at(3, 2)
    ...
    @staticmethod
    def test_white_rook_cannot_move_down_if_white_piece_is_in_way():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.WHITE)
        square = Square.at(3, 2)
    ...
    @staticmethod
    def test_black_rook_cannot_move_up_if_black_piece_is_in_way():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(3, 3)
    ...
    @staticmethod
    def test_black_rook_cannot_move_left_if_black_piece_is_in_way():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(3, 3)
    ...
    @staticmethod
    def test_black_rook_cannot_move_right_if_black_piece_is_in_way():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(3, 3)
    ...
    @staticmethod
    def test_black_rook_cannot_move_down_if_black_piece_is_in_way():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(3, 3)
    ...
    @staticmethod
    def test_white_rook_cannot_move_at_top_of_board():
    ...
    @staticmethod
    def test_white_rook_cannot_move_at_bottom_of_board():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.WHITE)
        square = Square.at(0, 0)
    ...
    @staticmethod
    def test_white_rook_cannot_move_at_left_of_board():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.WHITE)
        square = Square.at(0, 0)
    ...
    @staticmethod
    def test_white_rook_cannot_move_at_right_of_board():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.WHITE)
        square = Square.at(0, 7)
    ...
    @staticmethod
    def test_black_rook_cannot_move_at_top_of_board():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(7, 0)
    ...
    @staticmethod
    def test_black_rook_cannot_move_at_bottom_of_board():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(0, 0)
    ...
    @staticmethod
    def test_black_rook_cannot_move_at_left_of_board():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(0, 0)
    ...
    @staticmethod
    def test_black_rook_cannot_move_at_right_of_board():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(0, 7)
    ...
    @staticmethod
    def test_white_rooks_can_capture_cardinally():
    ...
    @staticmethod
    def test_black_rooks_can_capture_cardinally():
        # Arrange
        board = Board.empty()
        rook = Rook(Player.BLACK)
        square = Square.at(2, 2)
